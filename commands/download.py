...
def download(update, context):
    ...
    try:
        console_logger.info(f"[DOWNLOAD] Téléchargement de la vidéo pour l'URL: {url} par {update.message.from_user.username}")
        with yt_dlp.YoutubeDL(ydl_opts) as ydl:
        ...
        console_logger.error(f"[DOWNLOAD] Erreur téléchargement vidéo pour l'URL: {url} par {update.message.from_user.username} - {str(e)}")
